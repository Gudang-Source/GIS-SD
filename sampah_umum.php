...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="content-wrapper">
      <section class="content">
        <div class="box box-default">
          ...
          <div class="box-body">
            <form  action="sampah_umum.php" method="get" class="pull-right mail-src-position">
 ...
 <script>
  ...
  $sql = 'SELECT * FROM sampah where jenis ="umum" group by kecamatan order by kecamatan';
  ...
  if(isset($_GET['alamat'])){
    $alamat = $_GET['alamat'];
    $sql = "SELECT * FROM sampah where jalan like '%$alamat%' and jenis = 'umum'";
    $result = mysqli_query($conn, $sql);
    if (mysqli_num_rows($result) < 1) {
      $sql = 'SELECT * FROM sampah where jenis ="umum"';
      $result = mysqli_query($conn, $sql);
      $bool = true;
    }
  }
